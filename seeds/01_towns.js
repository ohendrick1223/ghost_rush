        ...
        .then(function() {
            return Promise.all([
                ...
                knex('towns').insert({
                    ...
                    yr_est: 1873,
                    yr_abnd: 1920,
                    short_desc: '<b>Animas Fork</b>, established in 1873, was founded for silver mining. It is a tourist attraction to this day with several structures standing and reinforced.',
                ...
                knex('towns').insert({
                    ...
                    description_now: "The town was destroyed by a 50-foot toddler in 1901, but a few buildings are still partially standing. Silver is long gone.",
                    cemetery: 'Yes',
                    mineral_found: 'Silver',
                    tour_avail: false,
